...
python3 tools/run_distributed_engines.py \
    ...
    config.MODEL.WEIGHTS_INIT.PARAMS_FILE="/mnt/archive/projectdata/drop/models/resnet50_imagenet_pretrained/resnet50_imagenet_pretrained_state_dict.torch" \
    config.MODEL.WEIGHTS_INIT.APPEND_PREFIX="trunk._feature_blocks." \
    config.MODEL.WEIGHTS_INIT.STATE_DICT_KEY_NAME="" \
    config.CHECKPOINT.DIR="./checkpoints/resnet50_moco_imagenet" \
